...
if __name__ == '__main__':
    img1 = cv2.imread(TEMPORARY_PATH + "template/image/002_L0360430010_0.jpg")
    img2 = cv2.imread(TEMPORARY_PATH + "template/image/002_L0360430010_2.jpg")

    img1 = imresize(img1, 1800)[:900,:,:]
    img2 = imresize(img2, 800)[:400,:,:]
